...
const (
	Aggregator_SubmitResults_FullMethodName = "/benchmark.Aggregator/SubmitResults"
)
...
func _Aggregator_SubmitResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AggregatorServer).SubmitResults(ctx, in)
	}
...
var Aggregator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "benchmark.Aggregator",
	HandlerType: (*AggregatorServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SubmitResults",
			Handler:    _Aggregator_SubmitResults_Handler,
		},
	},
